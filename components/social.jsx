...
const social = () => {
    return (
        <div orientation='left' className='social 2xl:block hidden'>
            <ul className='flex flex-col items-center m-0 p-0 list-none space-y-5'>
            <li>
                <a href="https://www.instagram.com/yahya_tahoune/" aria-label="Instagram" target="_blank" rel="noreferrer">
            ...
            <li>
                <a href="https://twitter.com/YT99Dev" aria-label="Twitter" target="_blank" rel="noreferrer">
            ...
            <li>
                <a href="https://www.linkedin.com/in/yahyatahoune/" aria-label="LinkedIn" target="_blank" rel="noreferrer">
                <svg className='m-auto' xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill='#f9f9f9' viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
                </a>
            </li>
            <li>
                <a href="https://github.com/RemoteSoul-hub" aria-label="GitHub" target="_blank" rel="noreferrer">
